...
public class TaskConsumerService {
        ...
        public TaskConsumerService(NotificationRepository notificationRepository) {
            this.notificationRepository = notificationRepository;
        }

        @RabbitListener(queues = RabbitMQConfig.NOTIFICATION_QUEUE)
        public void receiveInvoice(String invoice) {
            System.out.println("Processing Task Notification from queue: " + invoice);
            String emailTo = "mehdijk31m@gmail.com";
            String emailSubject = "New Task Scheduled";
